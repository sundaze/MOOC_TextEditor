	...
	private void processText()
	{
		...
		for(String tok: tokens)
		{
			...
			if(isWord(tok))
			{
				...
				//counting words
				numWords++;
				//counting end sentence with no punctuation
				if(tokens.indexOf(tok) == tokens.size()-1)
				{
					numSentences++;
				}
			}
...
//		System.out.print("There are " + numWords + " words, ");
//		System.out.print(numSyllables + " syllables and ");
//		System.out.println(numSentences + " sentences in this text.");
	}
