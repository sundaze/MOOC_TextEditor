...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			{
			BasicDocument doc1 = new BasicDocument(getStringFromFile(textfile, numToCheck));
			double result1 = doc1.getFleschScore();
			}
			long time1End = System.nanoTime();
			time1 = time1End - time1Start;
			System.out.print("[ " + time1 / 1000000 + " ]");
			
			//EfficientDocument
			long time2Start = System.nanoTime();
			for(int i = 0; i < trials; i++)
			{
			EfficientDocument doc2 = new EfficientDocument(getStringFromFile(textfile, numToCheck));
			double result2 = doc2.getFleschScore();
			}
			long time2End = System.nanoTime();
			time2 = time2End - time2Start;
			System.out.print("\t[ " + time2 / 1000000 + " ]\n");
